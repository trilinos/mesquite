...
/** \file IdealWeightInverseMeanRatioTest.cpp
 *  \brief unit tests for IdealWeightInverseMeanRatio quality metric
...
class IdealWeightInverseMeanRatioTest : public CppUnit::TestFixture
{
private:  

  CPPUNIT_TEST_SUITE(IdealWeightInverseMeanRatioTest);
