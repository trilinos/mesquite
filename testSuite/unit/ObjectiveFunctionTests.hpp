...
static void test_eval_type( ObjectiveFunction::EvalType type,
                            OFTestMode test_mode,
                            ObjectiveFunctionTemplate* of )
{
...
void test_clone( ObjectiveFunctionTemplate* of )
{
  ...
  for (unsigned i = 0; i < 2; ++i ) {
    switch (test_mode) {
      ...
      case HESS:
        ...
        break;
      default:
        CPPUNIT_ASSERT_MESSAGE(false,"Invalid enum value in test code");
        break;
    }
    ASSERT_NO_ERROR( err );
    CPPUNIT_ASSERT(rval);
...
static void test_handles_invalid_qm( OFTestMode test_mode,
                                     ObjectiveFunctionTemplate* of )
{
...
static void test_handles_qm_error( OFTestMode test_mode,
                                   ObjectiveFunctionTemplate* of )
