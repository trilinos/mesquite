...
TEST_METRIC_NO_DERIVS_2D( AWShape2DB1,       false, true,  true, true  );
TEST_METRIC_NO_DERIVS_2D( AWShape2DNB1,      false, true,  true, false );
TEST_METRIC_WITH_GRAD_2D( AWShape2DNB2,      false, true,  true, false );
