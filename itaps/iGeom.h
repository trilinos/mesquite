 ...
 * \param intersect_entity_handles_size Occupied size of intersections array
 * \param storage_order Storage order of coordinates passed back
 ...
 */
  ...
  void iGeom_resetEntArrIter( iGeom_Instance instance,
     ...
     * \param *err Pointer to error type returned from function
     */
  void iGeom_endEntIter( iGeom_Instance, iGeom_EntityIterator entity_iterator, int* err );
     ...
     * \param *err Pointer to error type returned from function
     */
  void iGeom_endEntArrIter( iGeom_Instance, iGeom_EntityArrIterator entArr_iterator, int* err );
