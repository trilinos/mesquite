...
/** \file Target3DShape.hpp
 *  \brief 
 *  \author Jason Kraftcheck 
 */

#ifndef MSQ_TARGET_3D_SHAPE_HPP
#define MSQ_TARGET_3D_SHAPE_HPP
...
/**\brief \f$ |T|^3 - 3 \sqrt{3} det(T) \f$
 *
 * A target metric for volume elements that optimizes
 * element shape
 */
class Target3DShape : public TargetMetric3D
{
public:
