...
/** \file Target3DShapeSizeAlt2.cpp
 *  \brief 
...
bool Target3DShapeSizeAlt2::evaluate_with_grad( const MsqMatrix<3,3>& A, 
                                                const MsqMatrix<3,3>& W, 
                                                double& result, 
                                                MsqMatrix<3,3>& wrt_A,
                                                MsqError&  )
...
bool Target3DShapeSizeAlt2::evaluate_with_hess( const MsqMatrix<3,3>& A,
                                                const MsqMatrix<3,3>& W,
                                                double& result,
                                                MsqMatrix<3,3>& wrt_A,
