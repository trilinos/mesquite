...
Target3DUntangleAlt1::~Target3DUntangleAlt1()
{}

msq_std::string Target3DUntangleAlt1::get_name() const
  { return "Untangle2"; }

bool Target3DUntangleAlt1::evaluate( const MsqMatrix<3,3>& A, 
...
bool Target3DUntangleAlt1::evaluate_with_grad( const MsqMatrix<3,3>& A,
                                               const MsqMatrix<3,3>& W,
                                               double& result,
...
bool Target3DUntangleAlt1::evaluate_with_hess( const MsqMatrix<3,3>& A,
                                               const MsqMatrix<3,3>& W,
                                               double& result,
                                               MsqMatrix<3,3>& deriv_wrt_A,
