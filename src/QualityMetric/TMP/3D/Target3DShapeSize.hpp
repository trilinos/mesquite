...
/** \file Target3DShapeSize.hpp
 *  \brief 
 *  \author Jason Kraftcheck 
 */

#ifndef MSQ_TARGET_3D_SHAPE_SIZE_HPP
#define MSQ_TARGET_3D_SHAPE_SIZE_HPP
 ...
 */
class Target3DShapeSize : public TargetMetric3D
{
private:
  double mGamma;
...
public:
  ...
  Target3DShapeSize( double gamma = 2.0 ) : mGamma(gamma) {}
