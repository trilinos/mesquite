...
/** \file Target3DShapeBarrier.hpp
 *  \brief 
 *  \author Jason Kraftcheck 
 */

#ifndef MSQ_TARGET_3D_SHAPE_BARRIER_HPP
#define MSQ_TARGET_3D_SHAPE_BARRIER_HPP
 ...
 * element shape
 */
class Target3DShapeBarrier : public TargetMetric3D
{
public:

  MESQUITE_EXPORT virtual
  ~Target3DShapeBarrier();
