...
/** \file Target3DOffset.hpp
 *  \brief 
 *  \author Jason Kraftcheck 
 */

#ifndef MSQ_TARGET3D_OFFSET_HPP
#define MSQ_TARGET3D_OFFSET_HPP
...
class Target3DOffset : public TargetMetric3D
{
  double mAlpha;
  TargetMetric3D* mMetric;

public:

  Target3DOffset( double alpha, TargetMetric3D* metric ) 
