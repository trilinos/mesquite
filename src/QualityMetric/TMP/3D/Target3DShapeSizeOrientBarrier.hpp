...
/** \file Target3DShapeSizeOrientBarrier.hpp
 *  \brief 
 *  \author Jason Kraftcheck 
 */

#ifndef MSQ_TARGET_3D_SHAPE_SIZE_ORIENT_BARRIER_HPP
#define MSQ_TARGET_3D_SHAPE_SIZE_ORIENT_BARRIER_HPP
...
/**\brief \f$ \frac{|T-I|^2}{2 det(T)} \f$
 *
 * A target metric for volume elements that optimizes
 * element shape, size, and orientation.
 */
class Target3DShapeSizeOrientBarrier : public TargetMetric3D
{
public:

  MESQUITE_EXPORT virtual
  ~Target3DShapeSizeOrientBarrier();
