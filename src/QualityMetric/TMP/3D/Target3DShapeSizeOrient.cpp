...
/** \file Target3DShapeSizeOrient.cpp
 *  \brief 
...
bool Target3DShapeSizeOrient::evaluate_with_grad( const MsqMatrix<3,3>& A, 
                                 const MsqMatrix<3,3>& W, 
                                 double& result, 
                                 MsqMatrix<3,3>& wrt_A,
                                 MsqError&  )
...
bool Target3DShapeSizeOrient::evaluate_with_hess( const MsqMatrix<3,3>& A,
                                     const MsqMatrix<3,3>& W,
                                     double& result,
