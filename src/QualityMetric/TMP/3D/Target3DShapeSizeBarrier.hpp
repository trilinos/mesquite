...
/** \file Target3DShapeSizeBarrier.hpp
 *  \brief 
 *  \author Jason Kraftcheck 
 */

#ifndef MSQ_TARGET3D_SHAPE_SIZE_BARRIER_HPP
#define MSQ_TARGET3D_SHAPE_SIZE_BARRIER_HPP
...
class Target3DShapeSizeBarrier : public TargetMetric3D
{
  public:
