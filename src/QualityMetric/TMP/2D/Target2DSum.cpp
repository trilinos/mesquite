...
msq_std::string Target2DSum::get_name() const
  { return mu1->get_name() + '+' + mu2->get_name(); }

bool Target2DSum::evaluate( const MsqMatrix<2,2>& A, 
...
bool Target2DSum::evaluate_with_grad( const MsqMatrix<2,2>& A,
                                      const MsqMatrix<2,2>& W,
                                      double& result,
...
bool Target2DSum::evaluate_with_hess( const MsqMatrix<2,2>& A,
                                      const MsqMatrix<2,2>& W,
                                      double& result,
                                      MsqMatrix<2,2>& deriv_wrt_A,
