...
/** \file Target2DScale.hpp
 *  \brief 
 *  \author Jason Kraftcheck 
 */

#ifndef MSQ_TARGET2D_SCALE_HPP
#define MSQ_TARGET2D_SCALE_HPP
...
class Target2DScale : public TargetMetric2D
{
  double mAlpha;
...
public:
  ...
  Target2DScale( double alpha, TargetMetric2D* metric ) 
