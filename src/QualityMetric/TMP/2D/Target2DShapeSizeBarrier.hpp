...
/** \file Target2DShapeSizeBarrier.hpp
 *  \brief 
 *  \author Jason Kraftcheck 
 */

#ifndef MSQ_TARGET2D_SHAPE_SIZE_BARRIER_HPP
#define MSQ_TARGET2D_SHAPE_SIZE_BARRIER_HPP
...
class Target2DShapeSizeBarrier : public TargetMetric2D
{
  public:
