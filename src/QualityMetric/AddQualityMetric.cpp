...
/*! Returns qMetric1->evaluate_element(element, err) plus
  qMetric2-evaluate_element(element, err)*/
bool AddQualityMetric::evaluate_element(PatchData& pd,
...
/*! Returns qMetric1->evaluate_vertex(...) plus
  qMetric2-evaluate_vertex(...)*/
bool AddQualityMetric::evaluate_vertex(PatchData& pd,
                                       MsqVertex* vert,
                                       double &value,
                                       MsqError& err)
{
