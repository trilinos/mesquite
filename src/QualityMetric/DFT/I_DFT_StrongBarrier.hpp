...
/*! \file I_DFT_StrongBarrier.hpp

Header file for the Mesquite::I_DFT_StrongBarrier class
...
*/
  ...
  class I_DFT_StrongBarrier : public I_DFT
  {
  public:
    
    I_DFT_StrongBarrier( TargetCalculator* tc, WeightCalculator* wc = 0 )
      : I_DFT( tc, wc )
    {
