...
void Mesquite::XYPlanarDomain::snap_to(Mesquite::Mesh::VertexHandle
                                       entity_handle,
...
void Mesquite::XYPlanarDomain::vertex_normal_at(
...
void Mesquite::XYPlanarDomain::element_normal_at(
