...
/** \file TRel3DOffset.hpp
 *  \brief 
 *  \author Jason Kraftcheck 
 */

#ifndef MSQ_TREL_3D_OFFSET_HPP
#define MSQ_TREL_3D_OFFSET_HPP
...
class TRel3DOffset : public TRel3DMetric
{
  double mAlpha;
...
public:
  ...
  TRel3DOffset( double alpha, TRel3DMetric* metric ) 
