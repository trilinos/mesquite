...
/** \file TRel3DShapeSizeOrientBarrierAlt1.cpp
 *  \brief 
...
std::string TRel3DShapeSizeOrientBarrierAlt1::get_name() const
  { return "ShapeSizeOrientBarrier1"; }

bool TRel3DShapeSizeOrientBarrierAlt1::evaluate( 
...
bool TRel3DShapeSizeOrientBarrierAlt1::evaluate_with_grad( 
                                             const MsqMatrix<3,3>& T,
                                             double& result,
...
bool TRel3DShapeSizeOrientBarrierAlt1::evaluate_with_hess( 
                                             const MsqMatrix<3,3>& T,
                                             double& result,
                                             MsqMatrix<3,3>& deriv_wrt_T,
