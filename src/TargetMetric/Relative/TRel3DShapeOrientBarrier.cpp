...
/** \file TRel3DShapeOrientBarrier.cpp
 *  \brief 
...
std::string TRel3DShapeOrientBarrier::get_name() const
  { return "ShapeOrientBarrier"; }

bool TRel3DShapeOrientBarrier::evaluate( const MsqMatrix<3,3>& T, 
                                         double& result, 
                                         MsqError&  )
{
...
bool TRel3DShapeOrientBarrier::evaluate_with_grad( const MsqMatrix<3,3>& T,
                                                   double& result,
                                                   MsqMatrix<3,3>& deriv,
                                                   MsqError& err )
{
...
bool TRel3DShapeOrientBarrier::evaluate_with_hess( const MsqMatrix<3,3>& T,
                                                   double& result,
                                                   MsqMatrix<3,3>& deriv,
