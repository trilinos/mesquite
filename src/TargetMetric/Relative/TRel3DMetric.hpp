...
#ifndef MSQ_TREL_3D_METRIC_HPP
#define MSQ_TREL_3D_METRIC_HPP
 ...
 *
 * Implement a scalar function \f$\mu(T)\f$ where T is a 3x3 matrix.
 */
class TRel3DMetric {
public:
    // used by code templatized to work with either this class or TRel3DMetric
  enum { MATRIX_DIM = 3 };
