...
TAbs3DMetric::~TAbs3DMetric() {}
     

bool TAbs3DMetric::evaluate_with_grad( const MsqMatrix<3,3>& A,
...
bool TAbs3DMetric::evaluate_with_hess( const MsqMatrix<3,3>& A,
                                       const MsqMatrix<3,3>& W,
                                       double& result,
