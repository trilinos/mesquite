...
/** \file TAbs3DShapeSizeOrient.hpp
 *  \brief 
 *  \author Jason Kraftcheck 
 */

#ifndef MSQ_TABS_3D_SHAPE_SIZE_ORIENT_HPP
#define MSQ_TABS_3D_SHAPE_SIZE_ORIENT_HPP
...
/** |A-W|^2 */
class TAbs3DShapeSizeOrient : public TAbs3DMetric
{
  public:
