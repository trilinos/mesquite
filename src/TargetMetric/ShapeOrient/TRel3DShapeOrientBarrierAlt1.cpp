...
/** \file TRel3DShapeOrientBarrierAlt1.cpp
 *  \brief 
...
std::string TRel3DShapeOrientBarrierAlt1::get_name() const
  { return "ShapeOrientBarrier"; }

bool TRel3DShapeOrientBarrierAlt1::evaluate( const MsqMatrix<3,3>& T, 
                                             double& result, 
                                             MsqError&  )
{
  double tau = det(T);
...
bool TRel3DShapeOrientBarrierAlt1::evaluate_with_grad( const MsqMatrix<3,3>& T, 
                                                       double& result, 
...
bool TRel3DShapeOrientBarrierAlt1::evaluate_with_Hess( const MsqMatrix<3,3>& T, 
                                                       double& result, 
                                                       MsqMatrix<3,3>& deriv_wrt_T,
