...
TAbs2DMetric::~TAbs2DMetric() {}
     

bool TAbs2DMetric::evaluate_with_grad( const MsqMatrix<2,2>& A,
...
bool TAbs2DMetric::evaluate_with_hess( const MsqMatrix<2,2>& A,
                                       const MsqMatrix<2,2>& W,
                                       double& result,
