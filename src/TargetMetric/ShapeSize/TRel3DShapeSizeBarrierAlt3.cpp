...
/** \file TRel3DShapeSizeBarrierAlt3.cpp
 *  \brief 
...
std::string TRel3DShapeSizeBarrierAlt3::get_name() const
  { return "ShapeSizeBarrier1"; }

bool TRel3DShapeSizeBarrierAlt3::evaluate( const MsqMatrix<3,3>& T, 
                                           double& result, 
                                           MsqError&  )
{
...
bool TRel3DShapeSizeBarrierAlt3::evaluate_with_grad( const MsqMatrix<3,3>& T,
                                                     double& result,
                                                     MsqMatrix<3,3>& deriv,
                                                     MsqError& err )
{
...
bool TRel3DShapeSizeBarrierAlt3::evaluate_with_hess( const MsqMatrix<3,3>& T,
                                                     double& result,
                                                     MsqMatrix<3,3>& deriv,
