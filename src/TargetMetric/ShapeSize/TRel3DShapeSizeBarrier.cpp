...
/** \file TRel3DShapeSizeBarrier.cpp
 *  \brief 
...
std::string TRel3DShapeSizeBarrier::get_name() const
  { return "ShapeSizeBarrier"; }

bool TRel3DShapeSizeBarrier::evaluate( const MsqMatrix<3,3>& T, 
                                       double& result, 
                                       MsqError&  )
{
...
bool TRel3DShapeSizeBarrier::evaluate_with_grad( const MsqMatrix<3,3>& T,
                                                 double& result,
...
bool TRel3DShapeSizeBarrier::evaluate_with_hess( const MsqMatrix<3,3>& T,
                                                 double& result,
                                                 MsqMatrix<3,3>& deriv_wrt_T,
