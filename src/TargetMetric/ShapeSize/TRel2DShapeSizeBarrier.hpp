...
/** \file TRel2DShapeSizeBarrier.hpp
 *  \brief 
 *  \author Jason Kraftcheck 
 */

#ifndef MSQ_TREL_2D_SHAPE_SIZE_BARRIER_HPP
#define MSQ_TREL_2D_SHAPE_SIZE_BARRIER_HPP
...
class TRel2DShapeSizeBarrier : public TRel2DMetric
{
  public:
