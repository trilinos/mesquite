...
std::string TRel2DShapeSizeAlt2::get_name() const
  { return "ShapeSize"; }

bool TRel2DShapeSizeAlt2::evaluate( const MsqMatrix<2,2>& T, 
                                    double& result, 
                                    MsqError&  )
{
...
bool TRel2DShapeSizeAlt2::evaluate_with_grad( const MsqMatrix<2,2>& T, 
                                              double& result, 
...
bool TRel2DShapeSizeAlt2::evaluate_with_hess( const MsqMatrix<2,2>& T, 
                                              double& result, 
                                              MsqMatrix<2,2>& deriv_wrt_T,
