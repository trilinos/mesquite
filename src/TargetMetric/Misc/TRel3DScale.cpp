...
/** \file TRel3DScale.cpp
 *  \brief 
 *  \author Jason Kraftcheck 
 */

#include "Mesquite.hpp"
#include "TRel3DScale.hpp"
#include "MsqMatrix.hpp"

namespace MESQUITE_NS {

std::string TRel3DScale::get_name() const
  { return "scale(" + mMetric->get_name() + ')'; }

bool TRel3DScale::evaluate( const MsqMatrix<3,3>& T, 
                            double& result, 
                            MsqError& err )
{
...
bool TRel3DScale::evaluate_with_grad( const MsqMatrix<3,3>& T,
                                      double& result,
...
bool TRel3DScale::evaluate_with_hess( const MsqMatrix<3,3>& T,
                                      double& result,
                                      MsqMatrix<3,3>& deriv_wrt_T,
